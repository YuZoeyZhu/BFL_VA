...
execute_balance_base <- function(test_site, sites, posterior_phi_full, sim_data_filtered_list) {
  
  library(rstan)
  library(caret)
  
  stan_model <- stan_model(file = "../code/BFL_no_partial_label.stan") 
  # message(paste("Processing BFL-base model for test site:", test_site))
